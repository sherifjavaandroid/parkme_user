...
import 'package:parkmepro/ui/auth_screen/otp_screen.dart';
  ...
  Future<UserCredential?> signInWithGoogle() async {
    try {
      ...
      if (googleUser == null) {
        ...
        ShowToastDialog.showToast("Google sign-in canceled.");
        return null;
      }
      ...
      if (googleAuth.accessToken == null && googleAuth.idToken == null) {
        ShowToastDialog.showToast("Failed to retrieve authentication tokens.");
        return null;
      }
