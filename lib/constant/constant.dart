...
class Constant {
  ...
  static String mapAPIKey = "AIzaSyBQqLPFT-z_pcC5-7nRYIvkMIBDJCtY8zk";
  ...
  static Widget showEmptyView({required String message}) {
    return Center(
      child: Text(message, style: const TextStyle(fontFamily: AppThemData.medium, fontSize: 18)),
    );
  }
